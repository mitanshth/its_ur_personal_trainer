...
- Shows a first-visit setup flow for name, login email, profile photo, age, height, weight, goal, experience, equipment, activity level, diet, injuries, and foods to avoid.
- Builds a personalized weekly workout plan from your goal, experience, schedule, session length, and equipment.
...
- Suggests daily protein, calories, carbs, fats, nutrition rules, and recipes from your dietary preference and avoided foods.
