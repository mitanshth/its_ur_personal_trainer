...
const exerciseLibrary = {
  ...
  bands: {
    chest: ["Bench Press - With Bands", "Cable Chest Press", "Incline Push-Up", "Standing Cable Chest Press", "Incline Push-Up Close-Grip"],
    back: ["Inverted Row", "Wide-Grip Lat Pulldown", "Band Pull Apart", "One-Arm Dumbbell Row", "Face Pull"],
    legs: ["Box Squat with Bands", "Band Good Morning", "Single Leg Glute Bridge", "Band Hip Adductions", "Split Squats"],
    shoulders: ["Shoulder Press - With Bands", "Lateral Raise - With Bands", "Alternating Deltoid Raise", "Back Flyes - With Bands", "Band Pull Apart"],
    arms: ["Standing Biceps Cable Curl", "Triceps Pushdown", "Hammer Curls", "Dumbbell One-Arm Triceps Extension", "Reverse Cable Curl"],
    core: ["Pallof Press", "Standing Cable Wood Chop", "Dead Bug", "Pallof Press With Rotation", "Alternating Renegade Row"],
    conditioning: ["Kettlebell Thruster", "Alternate Leg Diagonal Bound", "Walking, Treadmill", "Bodyweight Squat", "Band Pull Apart"],
    mobility: ["Band Pull Apart", "Kneeling Hip Flexor", "Standing Lateral Stretch", "Cat Stretch"]
  }
};
...
function mealPicture(meal) {
  const colors = {
    breakfast: ["#f2c14e", "#ffffff", "#ff5a3d"],
    lunch: ["#0d7c72", "#f2c14e", "#ffffff"],
    snack: ["#8f6bff", "#ffffff", "#ff5a3d"],
    dinner: ["#101814", "#0d7c72", "#f2c14e"]
  }[meal.type] || ["#0d7c72", "#ffffff", "#f2c14e"];
  return `
    <div class="meal-picture" aria-label="${meal.dish} meal picture">
      <svg viewBox="0 0 180 110" role="img" aria-label="${meal.meal} dish illustration">
        <rect width="180" height="110" rx="12" fill="#ffffff"></rect>
        <ellipse cx="90" cy="62" rx="62" ry="34" fill="#d8e2dd"></ellipse>
        <ellipse cx="90" cy="58" rx="52" ry="26" fill="#f8faf8"></ellipse>
        <circle cx="72" cy="54" r="18" fill="${colors[0]}"></circle>
        <circle cx="104" cy="55" r="17" fill="${colors[1]}" stroke="#d8e2dd" stroke-width="2"></circle>
        <path d="M88 72 C106 58 126 60 138 76" fill="none" stroke="${colors[2]}" stroke-width="12" stroke-linecap="round"></path>
        <path d="M42 24 C58 10 90 8 108 22" fill="none" stroke="#0d7c72" stroke-width="6" stroke-linecap="round"></path>
        <text x="90" y="101" text-anchor="middle" font-size="11" font-weight="900" fill="#607067">${meal.protein}g protein</text>
      </svg>
    </div>
  `;
}
