...
function postureSvg(move, accent) {
  ...
  const highlight = {
    Chest: `<ellipse cx="132" cy="82" rx="24" ry="16" fill="${accent}" opacity="0.9"></ellipse><text x="132" y="86" text-anchor="middle" font-size="10" font-weight="900" fill="#fff">CHEST</text>`,
    Back: `<path d="M108 62 C92 78 92 106 108 122 L156 122 C172 106 172 78 156 62 Z" fill="${accent}" opacity="0.9"></path><text x="132" y="96" text-anchor="middle" font-size="10" font-weight="900" fill="#fff">BACK</text>`,
    Legs: `<path d="M116 128 L96 196" stroke="${accent}" stroke-width="18" stroke-linecap="round"></path><path d="M148 128 L174 196" stroke="${accent}" stroke-width="18" stroke-linecap="round"></path><text x="134" y="178" text-anchor="middle" font-size="10" font-weight="900" fill="#101814">LEGS</text>`,
    Shoulders: `<circle cx="94" cy="76" r="15" fill="${accent}" opacity="0.95"></circle><circle cx="170" cy="76" r="15" fill="${accent}" opacity="0.95"></circle><text x="132" y="62" text-anchor="middle" font-size="10" font-weight="900" fill="#101814">SHOULDERS</text>`,
    Arms: `<path d="M88 86 L58 122" stroke="${accent}" stroke-width="16" stroke-linecap="round"></path><path d="M176 86 L206 122" stroke="${accent}" stroke-width="16" stroke-linecap="round"></path><text x="132" y="58" text-anchor="middle" font-size="10" font-weight="900" fill="#101814">ARMS</text>`,
    Core: `<rect x="112" y="96" width="40" height="48" rx="12" fill="${accent}" opacity="0.95"></rect><text x="132" y="124" text-anchor="middle" font-size="10" font-weight="900" fill="#fff">CORE</text>`,
    Conditioning: `<path d="M74 178 C104 146 152 146 190 178" fill="none" stroke="${accent}" stroke-width="12" stroke-linecap="round"></path><text x="132" y="160" text-anchor="middle" font-size="10" font-weight="900" fill="#101814">CARDIO</text>`,
    Mobility: `<path d="M82 154 C108 114 154 114 182 154" fill="none" stroke="${accent}" stroke-width="14" stroke-linecap="round"></path><text x="132" y="136" text-anchor="middle" font-size="10" font-weight="900" fill="#101814">MOBILITY</text>`
  }[part] || "";

  return `
    <svg viewBox="0 0 264 220" role="img" aria-label="${part} posture picture">
      <rect x="0" y="0" width="264" height="220" rx="14" fill="#f8faf8"></rect>
      <rect x="18" y="174" width="228" height="12" rx="6" fill="#d8e2dd"></rect>
      <line x1="40" y1="38" x2="40" y2="188" stroke="#d8e2dd" stroke-width="2" stroke-dasharray="5 6"></line>
      <text x="46" y="48" font-size="11" font-weight="900" fill="#607067">neutral spine</text>
      <circle cx="132" cy="36" r="18" fill="#101814"></circle>
      <path d="M132 54 L132 130" stroke="#101814" stroke-width="16" stroke-linecap="round"></path>
      <path d="M132 76 L88 112" stroke="#101814" stroke-width="14" stroke-linecap="round"></path>
      <path d="M132 76 L176 112" stroke="#101814" stroke-width="14" stroke-linecap="round"></path>
      <path d="M132 130 L104 194" stroke="#101814" stroke-width="15" stroke-linecap="round"></path>
      <path d="M132 130 L164 194" stroke="#101814" stroke-width="15" stroke-linecap="round"></path>
      ${highlight}
      <circle cx="132" cy="36" r="5" fill="#f2c14e"></circle>
      <path d="M98 42 C116 28 148 28 166 42" fill="none" stroke="#0d7c72" stroke-width="5" stroke-linecap="round"></path>
      <text x="132" y="210" text-anchor="middle" font-size="12" font-weight="900" fill="#607067">${move.name}</text>
    </svg>
  `;
}
