...
function postureSvg(move, accent) {
  ...
  const commonDefs = `
    <defs>
      <marker id="arrow-${part}" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="5" markerHeight="5" orient="auto-start-reverse">
  ...
  const poses = {
    Chest: `
      ...
      <path d="M152 88 C136 98 132 112 134 130" class="action-arrow" marker-end="url(#arrow-${part})"></path>
    ...
    Back: `
      ...
      <path d="M205 96 C184 96 170 94 150 86" class="action-arrow" marker-end="url(#arrow-${part})"></path>
    ...
    Legs: `
      ...
      <path d="M62 118 C82 138 104 148 130 150" class="action-arrow" marker-end="url(#arrow-${part})"></path>
    ...
    Shoulders: `
      ...
      <path d="M92 92 C94 70 96 58 104 42" class="action-arrow" marker-end="url(#arrow-${part})"></path>
      <path d="M172 92 C170 70 168 58 160 42" class="action-arrow" marker-end="url(#arrow-${part})"></path>
    ...
    Arms: `
      ...
      <path d="M80 154 C76 132 84 114 102 102" class="action-arrow" marker-end="url(#arrow-${part})"></path>
    ...
    Core: `
      ...
      <path d="M134 78 C126 96 126 116 134 136" class="action-arrow" marker-end="url(#arrow-${part})"></path>
    ...
    Conditioning: `
      ...
      <path d="M66 170 C104 188 158 188 206 164" class="action-arrow" marker-end="url(#arrow-${part})"></path>
    ...
    Mobility: `
      ...
      <path d="M76 132 C104 104 140 92 178 78" class="action-arrow" marker-end="url(#arrow-${part})"></path>
